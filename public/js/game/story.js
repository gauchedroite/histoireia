...
const formTemplate = () => {
    ...
    let rows = [];
    if (pageno > 0)
        add(`<div class="user">${user_text === null || user_text === void 0 ? void 0 : user_text.replace(/\n/g, "<br>")}</div>`);
    add(`<div id="ct_response">${(_a = assistant_text === null || assistant_text === void 0 ? void 0 : assistant_text.replace(/\n/g, "<br>")) !== null && _a !== void 0 ? _a : ""}</div>`);
    if (assistant_text && assistant_text.length > 0) {
        ...
        const textarea = Theme.renderFieldTextarea(NS, "next_user_text", next_user_text, "", { required: true, rows: 4 });
        add(label);
